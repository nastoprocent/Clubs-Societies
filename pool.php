...
<?php 
    ...
    if($valid==4)
    {
    $conn->query("INSERT INTO details (name, email, phone ,society,dateofbirth ) VALUES ( '".$_POST['name']."', '".$_POST['email']."', '".$_POST['phone']."','Pool', '".$_POST['dateofbirth']."')");
    $conn->close();
...
<head>
    ...
    <link href="css/pool/Poolslideshow.css" rel="stylesheet">
    <link href="css/music/facebookfloating.css" rel="stylesheet">
    <link href="css/pool/Poolshoutbox.css" rel="stylesheet">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
			          <a class="dropdown-toggle" data-toggle="dropdown" href="pool">Pool
            ...
            <div class="box">
                <div class="col-lg-12 text-center">
                    <hr>
                            ...
                            <h1 class="brand-name">  Pool Club</h1>
...
<br />
                   <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden; visibility: hidden;">
                        ...
                        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden;">
                            <div data-p="112.50">
                                <img data-u="image" src="img/pool/pool1.jpg" />
                            </div>
                            <a data-u="any" href="http://www.jssor.com" style="display:none">Banner Rotator</a>
                            <div data-p="112.50" style="display: none;">
                                <img data-u="image" src="img/pool/pool2.jpg" />
                            </div>
                            <div data-p="112.50" style="display: none;">
                                <img data-u="image" src="img/pool/pool3.jpg" />
                            </div>
                            <div data-p="112.50" style="display: none;">
                                <img data-u="image" src="img/pool/pool4.jpg"  />
                            </div>
                        </div>
                        <!-- Bullet Navigator -->
                ...
                <div class="col-lf-12">
                    <div id="page">
                        <div class="border rounded">
                            <shoutboxheading>Pool Society Shoutbox</shoutboxheading>
                        </div>
